...
const client = new Client({
  phoneNumber: '9647877581227', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "269277689069781@lid", jid: "9647877581227@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "269277689069781@lid", jid: "201142182793@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "201142182793@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "3QAB", jid: "201142182793@s.whatsapp.net", lid: "269277689069781@lid" }
  ],
